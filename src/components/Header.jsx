                ...
                <div className={`headerTop ${hamMenu ? 'gap0' : ''}`}>
                    <div className="headerTopItems">
                        ...
                        <div className="leftSection">
                                <div className="hamburgerIcon" onClick={openNavbar}>  
                        ...
                        <div className="top-navbar">
                                    <NavLink to={'/home'} className='mSubTitle txtWhite ls-2'>HOME</NavLink>
                                    <NavLink to={'/headphones'} className='mSubTitle txtWhite ls-2'>HEADPHONES</NavLink>
                                    <NavLink to={'/speakers'} className='mSubTitle txtWhite ls-2'>SPEAKERS</NavLink>
                                    <NavLink to={'/earphones'} className='mSubTitle txtWhite ls-2'>EARPHONES</NavLink>
                        </div>
