        ...
        <div className="selectionContent">
                    <div className="selectionProduct">
                        ...
                        <div className="selectionTexts">
                            ...
                            <div className="button3">
                                <NavLink to={'/headphones'} onClick={toggleHamMenu}><h5 className='mButton3'>SHOP</h5></NavLink>
                    ...
                    <div className="selectionProduct">
                        ...
                        <div className="selectionTexts">
                            ...
                            <div className="button3">
                            <NavLink to={'/speakers'} onClick={toggleHamMenu}><h5 className='mButton3'>SHOP</h5></NavLink>
                                <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path   d="M1.32178 1L6.32178 6L1.32178 11" stroke="#D87D4A" stroke-width="2"/>
                                </svg>
                            </div>
                    ...
                    <div className="selectionProduct">
                        ...
                        <div className="selectionTexts">
                            ...
                            <div className="button3">
                            <NavLink to={'/earphones'} onClick={toggleHamMenu}><h5 className='mButton3'>SHOP</h5></NavLink>
                                <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path   d="M1.32178 1L6.32178 6L1.32178 11" stroke="#D87D4A" stroke-width="2"/>
                                </svg>
                            </div>
